...
#define MCA_BTL_TIPC_FRAG_ALLOC_EAGER(frag)                                                       \
    {                                                                                            \
        frag = (mca_btl_tipc_frag_t *) opal_free_list_get(&mca_btl_tipc_component.tipc_frag_eager); \
    }

#define MCA_BTL_TIPC_FRAG_ALLOC_MAX(frag)                                                       \
    {                                                                                          \
        frag = (mca_btl_tipc_frag_t *) opal_free_list_get(&mca_btl_tipc_component.tipc_frag_max); \
    }

#define MCA_BTL_TIPC_FRAG_ALLOC_USER(frag)                                                       \
    {                                                                                           \
        frag = (mca_btl_tipc_frag_t *) opal_free_list_get(&mca_btl_tipc_component.tipc_frag_user); \
    }
...
bool mca_btl_tipc_frag_send(mca_btl_tipc_frag_t *, int sd);
