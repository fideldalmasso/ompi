...
#ifndef MCA_BTL_TIPC_HDR_H
#define MCA_BTL_TIPC_HDR_H
...
#define MCA_BTL_TIPC_HDR_TYPE_FIN  4
/* The MCA_BTL_TIPC_HDR_TYPE_FIN is a special kind of message sent during normal
